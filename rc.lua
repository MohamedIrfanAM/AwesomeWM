...
local myawesomemenu = {
    ...
    { "edit config", terminal.." nvim /home/irfan/.config/awesome/rc.lua" },
    { "arandr", "arandr" },
...
globalkeys = my_table.join(
    ...
    awful.key({ altkey, "Control" }, "e", function () awful.util.spawn( "/.dmenu/dmscripts/dmconf" ) end,
        {description = "edit config files" , group = "dmenu scripts" }),
    awful.key({ altkey, "Control" }, "q", function () awful.util.spawn( "/.dmenu/dmscripts/dmkill" ) end,
        {description = "Kill apps" , group = "dmenu scripts" }),
    awful.key({ altkey, "Control" }, "x", function () awful.util.spawn( "/.dmenu/dmscripts/dmlogout" ) end,
        {description = "Logout" , group = "dmenu scripts" }),
    awful.key({ altkey, "Control"  }, "s", function () awful.util.spawn( "/.dmenu/dmscripts/dmsearch" ) end,
        {description = "web search" , group = "dmenu scripts" }),
    awful.key({ altkey, "Control"  }, "m", function () awful.util.spawn( "/.dmenu/dmscripts/dman" ) end,
        {description = "Search man pages" , group = "dmenu scripts" }),
    ...
    -- Focus on tags
    awful.key({modkey1,altkey}, "l",  awful.tag.viewnext,
              {description = "view next", group = "tag"}),
    awful.key({ modkey1,altkey}, "h",   awful.tag.viewprev,
              {description = "view previous", group = "tag"}),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    --           {description = "decrease the number of master clients", group = "layout"}),
    -- awful.key({ altkey, "Shift" }, "h",     function () awful.tag.incncol( 1, nil, true)    end,
    --           {description = "increase the number of columns", group = "layout"}),
 ...
 -- client extend up , down , right , left
   awful.key({ modkey,"Control"  }, "l",     function () client_resize('Right')         end,
      {description = "increase master width factor", group = "layout"}),
   awful.key({ modkey,"Control"  }, "h",     function () client_resize('Left')        end,
      {description = "decrease master width factor", group = "layout"}),
   awful.key({ modkey,"Control"  }, "k",     function () client_resize('Up')           end,
      {description = "increase client height factor", group = "layout"}),
   awful.key({ modkey,"Control"  }, "j",     function () client_resize('Down')         end,
   ...
   awful.key({ modkey, "Shift" }, "space",
    ...
    -- awful.key({ altkey, }, "'", function () if beautiful.weather then beautiful.weather.show(7) end end,
...
awful.spawn.with_shell("xinput set-prop 'ETPS/2 Elantech Touchpad' 315 1")
